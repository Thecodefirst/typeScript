export default {
  ...
  personalList: {
    ...
    probation: '试用期合同（月）',
    positive: '转正时间',
    politics_status: '整治面貌',
    working_state: '在职状态ID',
    working_state_name: '在职状态',
    departure_date: '离职日期',
    account_type: '户口类型ID',
    account_type_name: '户口类型',
    take_job_date: '参加工作日期',
    present_address: '现住址',
    contract_over_date: '合同到期日期',
    bank_deposit: '开户银行',
    card_no: '银行卡号',
  ...
  attendanceList: {
    ...
    departmentName: '部门',
    userName: '姓名',
    should_attendance_days: '应出勤天数',
    attendance_days: '实际出勤天数',
    attendance_work_time: '工作时长(分钟)',
    leave_sick: '病假',
    leave_personal: '事假',
    lateNum: '迟到次数',
    earlyNum: '早退次数',
    ...
    leave_maternity: '产假',
    leave_paternity: '陪产假',
    leave_breastfeeding: '哺乳假',
    leave_marriage: '婚假',
    business_trip_time: '出差天数'
  }
}
