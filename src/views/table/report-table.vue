...
import { whetherAiReport, getAttcolumns } from '@/api/report'
...
export default class extends Vue {
  ...
  private async lookAttcolumns() {
    const { data } = await getAttcolumns()
    console.log(data)
  }

  private async lookAiReport() {
    const { data } = await whetherAiReport()
    console.log(data)
  }
